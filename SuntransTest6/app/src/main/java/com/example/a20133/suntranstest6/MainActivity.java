package com.example.a20133.suntranstest6;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initPopWindow(View v) {
       ...
       final PopupWindow popWindow = new PopupWindow(view,
        ...
        int padding = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,360,mContext.getResources().getDisplayMetrics());
